...
# Form implementation generated from reading ui file 'C:\Users\Rudrigo\Desktop\SENFIO\designer\tela_calibra.ui'
#
...
class Ui_FormCalibra(object):
    def setupUi(self, FormCalibra):
        FormCalibra.setObjectName("FormCalibra")
        FormCalibra.resize(650, 518)
        FormCalibra.setStyleSheet("background-color: rgb(247, 247, 247);")
        self.verticalLayout = QtWidgets.QVBoxLayout(FormCalibra)
        self.verticalLayout.setObjectName("verticalLayout")
        self.frame = QtWidgets.QFrame(FormCalibra)
        ...
        self.frame_2 = QtWidgets.QFrame(FormCalibra)
        ...
        self.frame_4 = QtWidgets.QFrame(FormCalibra)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}")
        ...
        self.retranslateUi(FormCalibra)
        self.btnSairCalibra.clicked.connect(FormCalibra.close) # type: ignore
        QtCore.QMetaObject.connectSlotsByName(FormCalibra)

    def retranslateUi(self, FormCalibra):
        _translate = QtCore.QCoreApplication.translate
        FormCalibra.setWindowTitle(_translate("FormCalibra", "Calibração"))
        self.label.setText(_translate("FormCalibra", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:600;\">Calibração - Firmware</span></p></body></html>"))
        self.groupBox.setTitle(_translate("FormCalibra", "Arquivo 4 - Dinâmico - 0x00010000"))
        self.label_6.setText(_translate("FormCalibra", "Nome: "))
        self.label_2.setText(_translate("FormCalibra", "Path: "))
        self.groupBox_3.setTitle(_translate("FormCalibra", "Arquivo 4 - Dinâmico - 0x00010000"))
        self.label_8.setText(_translate("FormCalibra", "Nome: "))
        self.label_4.setText(_translate("FormCalibra", "Path: "))
        self.groupBox_4.setTitle(_translate("FormCalibra", "Arquivo 4 - Dinâmico - 0x00010000"))
        self.label_9.setText(_translate("FormCalibra", "Nome: "))
        self.label_5.setText(_translate("FormCalibra", "Path: "))
        self.groupBox_5.setTitle(_translate("FormCalibra", "Arquivo 4 - Dinâmico - 0x00010000"))
        self.label_10.setText(_translate("FormCalibra", "Nome: "))
        self.label_11.setText(_translate("FormCalibra", "Path: "))
        self.btnSairCalibra.setText(_translate("FormCalibra", "Sair"))
        self.btnSalvarCalibra.setText(_translate("FormCalibra", "Salvar"))
